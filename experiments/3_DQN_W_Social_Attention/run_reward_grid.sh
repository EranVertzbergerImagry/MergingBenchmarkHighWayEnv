#!/usr/bin/env bash
#
# Grid search over high_speed_reward x arrived_reward for experiment 3 (Social Attention DQN).
#
# Usage:
...
CONF
    ...
    python "$SCRIPT_DIR/train_social_attention_dqn.py" --config "$config"
